...
import com.application.app.databinding.RowExplore1Binding
import com.application.app.modules.explore.`data`.model.Explore1RowModel
import kotlin.Int
import kotlin.Unit
import kotlin.collections.List

public class RecyclerArticleListAdapter(
  public var list: List<Explore1RowModel>
) : RecyclerView.Adapter<RecyclerArticleListAdapter.RowExplore1VH>() {
  ...
  public inner class RowExplore1VH(
    ...
    init {
      binding.linearGroup44.setOnClickListener {
